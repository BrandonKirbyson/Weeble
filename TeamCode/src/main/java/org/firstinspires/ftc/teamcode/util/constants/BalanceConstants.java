...
public class BalanceConstants {
    ...
    public static PIDConstants IdlePID = new PIDConstants(0.06, 0.0006, 1, 0.4);
    public static PIDConstants IdleAnyTerrainPID = new PIDConstants(0.065, 0.0006, 1, 0.4);
    public static PIDConstants UprightPID = new PIDConstants(0.1, 0.0, 0.8, 0.1);
    public static PIDConstants DrivePID = new PIDConstants(0.06, 0.003, 1, 0.3);
